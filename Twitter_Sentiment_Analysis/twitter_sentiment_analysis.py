...
class SentimentAnalysis:
    ...
    def DownloadData(self):
        ...
        print("\nFirst " + str(NoOfTerms) + " Tweets on " + searchTerm + ":\n")
        ...
        for tweet in self.tweets:
            ...
            if (analysis.sentiment.polarity == 0.0):  # adding reaction of how people are reacting to find average later
                neutral += 1
                ...
                spositive += 1
            elif (analysis.sentiment.polarity > -0.3 and analysis.sentiment.polarity <= 0.0):
                wnegative += 1
