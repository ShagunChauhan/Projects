...
class twitter_bot(object):
    ...
    def bot_prediction_algorithm(df):
        ...
        train_df = df.copy()
        # performing feature engineering on id and verfied columns and converting id to int
        ...
        # check if the name contains bot or screenname contains b0t because these all are bots
